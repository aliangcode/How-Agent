...
本教程面向希望系统学习智能体开发的读者，本来是我为一个探索项目给同学们准备的一个系统学习材料，内容从智能体基础概念逐步推进到最小实现与工程实践，准备过程中，我发现这个材料也适合作为自学材料、课程参考资料或教学配套讲义使用。
...
- 记忆、检索
- 低代码平台等进阶主题。
后面还有一些内容，可能想陆续加进来吧。技术发展的实在太快，在准备材料的过程中，时间仓促，还有很多不完善。
